                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">{{ $details['product']['quantity'] }}
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="no-line text-end">Rp{{ $payment->discount_amount }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="no-line"></td>
                                                        ...
                                                        <td class="no-line text-end">Rp{{ $payment->paid_amount }}</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="no-line text-end">
                                                            <h4 class="m-0">Rp{{ $payment->total_amount }}</h4>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
